                     ...
                     <div class="col-lg-12">
                                        ...
                                        <div class="panel panel-primary">
                                            ...
                                            <div class="panel-body">
                                              ...
                                              <form method="POST" class="form-horizontal" action="{{ route('Visit', ['appointment_id'=>$appointment_id,'walk_in_id'=>$walk_in_id,]) }}">
                                                     {{ csrf_field() }}
                                                <div class="row">
                                                    <div class="col-md-6">
                        ...
                        <div class="panel panel-info filterable">
                            ...
                            <div class="panel-body">
                                <table class="table table-striped table-responsive" id="table2">
                                    ...
                                    <tbody>
                                                       @foreach($phistoryapp as $key =>$p)
                                        <tr>
                                            <td>{{ $p->visit_date_time }}</td>
                                            <td>{{ $p->visit_patient_symptomps }}</td>
                                            <td>{{ $p->visit_remarks  }}</td>
                                                                 <td>
