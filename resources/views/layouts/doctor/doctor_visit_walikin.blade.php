...
<aside class="right-side">
            ...
            <section class="content-header">
                <h1> 
                                        Records of {{ $patient->patient_last  . ", " . $patient->patient_first }} 
                     ...
                     <div class="col-lg-12">
                                        ...
                                        <div class="panel panel-primary">
                                            ...
                                            <div class="panel-body">
                                              <form method="POST" class="form-horizontal" action="{{ route('Visit',['id'=>$walk_in_id]) }}">
                                                     {{ csrf_field() }}
                                                <div class="row">
                                                    <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                        <label class="control-label col-md-3" for="postalAddress">Diagnosis</label>
                                                            ...
                                                            {!!Form::select('diagnosis_id[]',$diagnosis,null,['id'=>'multiple','class'=>'form-control select2-multiple', 'name'=>'diagnosis[]', 'multiple'=>'true'])!!}
                                                ...
                                                <span class="glyphicon glyphicon-plus"></span>
                                                    ...
                                                    <div class="form-group">
                                                        <label class="control-label col-md-3" for="postalAddress">Prescription</label>
                                                             <div class="col-md-9 input-group select2-bootstrap-append">
                                                             {!!Form::select('medicine_id[]',$medicine,'null',['id'=>'multiple','class'=>'form-control select2-multiple', 'name'=>'medicine[]', 'multiple'=>'true'])!!}
                                                              <span class="input-group-btn">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div style="float: right" >
                                                           ...
                                                           <button type="reset" class="btn btn-default" value="Reset"><span class="glyphicon glyphicon-off" title="Reset" ></span>
                                                            ...
                                                            <button class="btn btn-primary" data-toggle="modal" data-href="#responsivefin" href="#responsivefin"><span class="glyphicon glyphicon-floppy-disk"></span></button>
                                                            </div>
                                                    </div>
                ...
                <div class="modal fade in" id="responsive" tabindex="-1" role="dialog" aria-hidden="false" style="display:none;">
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form method="POST" class="form-horizontal" action="{{ url('Visit-diag') }}">
                                                     {{ csrf_field() }}
                                <div class="row">
                        ...
                        <div class="modal-content">
                            <div class="modal-header">
                                ...
                                <h4 class="modal-title">Add Diagnosis</h4>
                                                             ...
                                                             <div class="panel-body">
                                             <form method="POST" class="form-horizontal" action="{{ url('Visit-med') }}">
                                             {{ csrf_field() }}
                                                <div class="row">
                            ...
                            <div class="panel-body">
                                <table class="table table-striped table-responsive" id="table1">
                                    ...
                                    @foreach($vitals as $key =>$v)
                                        <tr>
                                            <td>{{ $v->vitals_date_time }}</td>
                                            <td>{{ $v->vitals_patient_weight_kilos }}</td>
                                            <td>{{ $v->vitals_patient_height_cm  }}</td></td>
                                            <td>{{ $v->vitals_patient_bpsystoli  . "/" . $v->vitals_patient_diastolic }}</td>
                                            <td>{{ $v->vitals_patient_temp_celsius }}</td>
                                            <td>{{ $v->vitals_patient_respiration_rate_min }}</td>
                                             <td>{{ $v->vitals_patient_pulse_rate_min  }}</td>
                                              <td>{{ $v->vitals_patient_heart_rate_min   }}</td>
                                        </tr>
                                    @endforeach
                                    </tbody>
                                </table>
                        ...
                        <div class="panel panel-info filterable">
                            ...
                            <div class="panel-body">
                                <table class="table table-striped table-responsive" id="table2">
                                    ...
                                    <tbody>
                                                       @foreach($phistorywalk as $key =>$w)
                                        <tr>
                                            <td>{{ $w->visit_date_time }}</td>
                                            <td>{{ $w->visit_patient_symptomps }}</td>
                                            <td>{{ $w->visit_remarks  }}</td>
                                                                 <td>
