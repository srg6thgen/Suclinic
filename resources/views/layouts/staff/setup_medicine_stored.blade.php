                ...
                <div class="panel panel-primary filterable" style="overflow:auto;">
                    ...
                    <div class="panel-body">
                        <table class="table table-striped table-bordered" id="table1">
                            ...
                            <tbody>
                                @foreach($medicine as $key =>$ms)
                                <tr>
                                   <td style="display:none;">{{ $ms->medicine_id}}</td>
                                    <td>{{ $ms->medicine_generic_name}}</td>
                                    <td>{{ $ms->medicine_packaging}}</td>
                                    <td>{{ $ms->medicine_date_added}}</td>
                                    <td>{{ $ms->medicine_active}}</td>
                                    <td>
                                        <div class="col-sm-1">
                                            <a href="#">
                                                <i class="glyphicon glyphicon-download-alt" data-toggle="modal" data-href="#full-width" href="#responsive_{{ $ms->medicine_id}}" data-c="#f56954" data-hc="#f56954" title="Store"></i>
                                            </a>
                                            <div class="modal fade" id="responsive_{{ $ms->medicine_id}}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                        ...
                                        Medicine Name: {{ $ms->medicine_generic_name}}
                                    </h4>
                                                        </div>
                                                        <div class="modal-body">
                                                            <div class="form-group">
                                                                <form method="POST" class="form-horizontal" action="{{ route('ManageMedicineStored_med', ['id' =>$ms->medicine_id]) }}">
                                                                    {{ csrf_field() }}
