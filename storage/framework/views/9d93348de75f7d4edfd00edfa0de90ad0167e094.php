<?php $__env->startSection('title', 'Employee Setup'); ?>
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <div class="panel panel-primary">
                                            ...
                                            <div class="panel-body">
                                              <form method="POST" class="form-horizontal" action="<?php echo e(url('ManageEmployee')); ?>">
                                    ...
                                    <tbody>
                                      <?php $__currentLoopData = $employee; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key =>$e): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td><?php echo e($e->employee_position); ?></td>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="panel panel-primary">
                                            ...
                                            <div class="panel-body">
                                               ...
                                               <?php echo Form::open(array('route' => 'import-employee','method'=>'POST','files'=>'true')); ?>

                                                <div class="row">
                                                 <div class="col-xs-12 col-sm-12 col-md-12">
                                                        <div class="form-group">
                                                            <?php echo Form::label('emp_file','Select File to Import:',['class'=>'col-md-3']); ?>

                                                            <div class="col-md-9">
                                                            <?php echo Form::file('emp_file', array('class' => 'form-control')); ?>

                                                            <?php echo $errors->first('emp_file', '<p class="alert alert-danger">:message</p>'); ?>
