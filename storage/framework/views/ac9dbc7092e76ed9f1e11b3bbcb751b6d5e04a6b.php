<?php $__env->startSection('title', 'Users Setup'); ?>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="panel panel-primary">
                                            ...
                                            <div class="panel-body">
                                             <form method="POST" class="form-horizontal" action="<?php echo e(url('/ManageUsers')); ?>">
                                            ...
                                            <span class="input-group-addon ">
                                                <span class="glyphicon glyphicon-th "></span>
                                                            ...
                                                            <div class="form-group col-md-6">
                                                                ...
                                                                <div class="col-md-9">
                                                                <?php echo Form::select('id',$roles,null,['id'=>'id','class'=>'form-control select2', 'name'=>'roleselect']); ?>
