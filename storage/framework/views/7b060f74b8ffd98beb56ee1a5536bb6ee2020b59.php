<?php $__env->startSection('title', 'Student Setup'); ?>
                        ...
                        <div class="panel panel-primary">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <form class="form-wizard" action="<?php echo e(url('ManageStudent')); ?>" method="POST">
                                                        ...
                                                        <?php $__currentLoopData = $student; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key =>$s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                         <tr>
                                                             <td><?php echo e($s->student_number); ?></td>     
                                                                ...
                                                                <td><?php echo e($s->student_status); ?></td>
                                             ...
                                             <div class="panel-body">
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        ...
                                                        <?php echo Form::open(array('route' => 'import-csv-excel-student','method'=>'POST','files'=>'true')); ?>

                                                        <div class="row">
                                                           <div class="col-xs-12 col-sm-12 col-md-12">
                                                                <div class="form-group">
                                                                    <?php echo Form::label('stud_file','Select File to Import:',['class'=>'col-md-3']); ?>

                                                                    <div class="col-md-9">
                                                                    <?php echo Form::file('stud_file', array('class' => 'form-control')); ?>

                                                                    <?php echo $errors->first('stud_file', '<p class="alert alert-danger">:message</p>'); ?>
