                    ...
                    <li class="dropdown user user-menu">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-header bg-light-blue">
                                ...
                                <p class="topprofiletext"><?php echo e(Auth::user()->first_name); ?></p>
                            </li>
                            <!-- Menu Body -->
                            <li>
                                <a href="#">
            ...
            <section class="sidebar ">
                <div class="page-sidebar  sidebar-nav">
                    ...
                    <ul id="menu" class="page-sidebar-menu">
                        <li class="active">
                            <a href="<?php echo e(route('staff_dashboard')); ?>">
                        ...
                        <li>
                            ...
                            <li>
                            <a href="<?php echo e(route('AddPatient.index')); ?>">
                                ...
                                <li>
                                    <a href="<?php echo e(route('ManageMedicine.index')); ?>">
                                    ...
                                    <li>
                                    <a href="<?php echo e(route('ManageUtility.index')); ?>">
                                ...
                                <li>
                                    <a href="<?php echo e(route('ManageRoom.index')); ?>">
                            ...
                            <ul class="sub-menu">
                            <li>
                                    <a href="<?php echo e(route('ManageMedicineStored.index')); ?>">
                                        <i  class="livicon" data-name="lab" data-c="#5bc0de" data-hc="#5bc0de" data-size="18" data-loop="true"></i>
                                        Medicine Management
                                    </a>
                                </li>
                                    ...
                                    <li>
                                    <a href="<?php echo e(route('ManageUtilityStored.index')); ?>">
                                        <i  class="livicon" data-name="wrench" data-c="#5bc0de" data-hc="#5bc0de" data-size="18" data-loop="true"></i>
                                        Utility Management
                                    </a>
                                </li>
                    ...
                    <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                        <div class="modal-dialog">
                                ...
                                <div class="form-group">
                                    ...
                                    <?php $__currentLoopData = $patient_employee; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key =>$pe): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                             <option value= "<?php echo e($pe->patient_id); ?>"> <?php echo e($pe->employee_firstname .' '.$pe->employee_lastname); ?> (<i><?php echo e($pe->patient_account_no); ?></i>)</option>
                                         <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </optgroup>

                                        <optgroup label="Student">
                                        <?php $__currentLoopData = $patient_student; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key =>$ps): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value= "<?php echo e($ps->patient_id); ?>"> <?php echo e($ps->student_firstname .' '.$ps->student_lastname); ?> (<i><?php echo e($ps->patient_account_no); ?></i>)</option>
                                         <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </optgroup>
                                ...
                                <div class="form-group">
                                    ...
                                    <select id="e1" name="appointment_type" class="form-control select2">
                                         <?php $__currentLoopData = $apptype; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key =>$a): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                             <option value= "<?php echo e($a->appointment_type_id); ?>"> <?php echo e($a->appointment_type_title); ?> (<i><?php echo e($a->appointment_type_duration); ?>mins</i>)</option>
                                         <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                </div>
                                ...
                                <div class="form-group">
                                   <label>Appointment Time</label>
                                        <div class="input-group date form_datetime" data-date="<?php echo e(Carbon\Carbon::now()); ?>" id="datetimepickers" >
